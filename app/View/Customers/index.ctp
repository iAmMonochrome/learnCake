<div class="customers index">
	...
	<div class='action--search'>
		...
		<div class='d-flex align-items-center justify-content-start'>
			...
			<?php echo $this->Html->link(__('Reset'), ['action' => 'reset'], ['class' => 'btn btn-danger mt-3']); ?>
		</div>
		<?php echo $this->Form->end('Search', ['class' => 'btn btn-success']); ?>
	</div>
	...
	<?php endif ?>
	<?php if($is_empty == false && $not_found == false){
	?>
		<!-- End View Results -->
